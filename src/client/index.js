...
import {createGenerateButtonEventListener} from './js/app';
...
/* Export an IIFE (immediately invoked function expression) which creates an event listener (using the createGenerateButtonEventListener function that was imported from the /client/js/app.js file above).
